---
layout: post
title: Script Odoo 17 en Ubuntu
subtitle: Script Odoo 17 en Ubuntu
image: /img/icono-odoo.png
tags: [python, libreria,Packaging ,Projects,odoo 17, Comunidad]
---

**Script para Instalar Odoo 17**
...
nano installodoo17.sh

~~~ 

**2.- Contenido del script**

contenido de installodoo17.sh
...
# Creamos el directorio en donde se almacenará el archivo de configuración y log de odoo:
...
# Descargamos odoo versión 17 desde git:
...
# Creamos la configuración de Odoo:
...
~~~
sudo chmod u+x installodoo17.sh
~~~

**4.- Ejecutar del script**

~~~
sudo sh installodoo17.sh
~~~

**5.- Abrir navegador**

Finalmente abrimos un navegador web y colocamos: http://IP:8069
